    ...
    def __init__(
        ...
        **start_parm,
        ...
        if remove_temp_files is not None:  # pragma: no cover
            warnings.warn(
                "The option ``remove_temp_files`` is being deprecated and it "
                "will be removed by PyMAPDL version 0.66.0.\n"
    ...
    def _get(self, entity, entnum, item1, it1num, item2, it2num):
        ...
        if getresponse.type == 0:
            ...
            try:
                ...
                # Get can thrown some errors, in that case, they are caught in the
                # default run method.
                raise
            else:
        ...
        * If you are in local and provide a file path, downloading files
        ...
        for each_file in list_files:
            try:
                ...
                # recursive does not work in remote.
                self._download(
                    each_file,
